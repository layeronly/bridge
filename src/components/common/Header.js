            ...
            <header className='app_header'>
                <Navbar expand="lg" variant="dark">
                    <Container fluid>
                        ...
                        <Navbar.Toggle aria-controls="navbarScroll" style={{ color: '#fff', backgroundColor: '#3959FF' }} />
                        <Navbar.Collapse id="navbarScroll">
                            ...
                            <div className='right_header_wrap'>
                                ...
                                <div className='header_btn_wrap'>
                                    {
                                        isConnected ? <button className='btn disconnect_btn header_btn me-2'><FaEthereum style={{color: "#000",}} />{getNetwork}</button> : ""
                                    }
